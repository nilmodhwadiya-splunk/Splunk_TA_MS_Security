        ...
        for input_name, input_item in inputs.inputs.items():
            ...
            if access_token:
                ...
                for alert in alerts:
                    ...
                    atp_alerts_ingested = atp_alerts_ingested + 1
                logger.info(
                    f"Total ATP Alerts ingested - atp_alert_count={atp_alerts_ingested}"
                )
                checkpoint_handler(
                    logger,
                    session_key,
